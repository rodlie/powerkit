...
public:
    ...
    static bool availableService(const QString &service,
                           const QString &path,
                           const QString &interface);
    static bool availableAction(const PKMethod &method,
                                const PKBackend &backend);
    static QString executeAction(const PKAction &action,
                                 const PKBackend &backend);
    static QStringList findDevices();

    static bool hasConsoleKit();
