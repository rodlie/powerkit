...
QMap<QString, bool> Monitor::getX()
{
    QMap<QString, bool> result;
    Display *dpy;
...
QString Monitor::turnOffMonitorUsingXrandr(QString display)
{
    return QString(TURN_OFF_MONITOR).arg(display);
}

QString Monitor::turnOnMonitorUsingXrandr(QString display)
{
...
monitorInfo Monitor::getMonitorInfo(QString display)
{
    monitorInfo result;
